...
--
-- Host: localhost:3306
-- Waktu pembuatan: 13 Jul 2025 pada 07.01
-- Versi server: 8.0.30
-- Versi PHP: 8.1.10
...
CREATE TABLE `diagnosa_akhir` (
  ...
  `jenis_diagnosa` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `diagnosa_akhir` (`id`, `pasien_id`, `user_id`, `tanggal`, `diagnosa`, `catatan`, `created_at`, `updated_at`, `master_diagnosa_id`, `jenis_diagnosa`, `kasus`, `pelayanan_id`) VALUES
(1, 1, 3, '2025-06-02', 'Migrain kronis', 'Respon baik terhadap terapi. Lanjutkan pengobatan.', '2025-06-10 23:02:44', '2025-06-25 20:06:29', 5, NULL, NULL, 3),
(2, 2, 3, '2025-06-05', 'Asma stabil', 'Kondisi membaik, kontrol sebulan kemudian.', '2025-06-10 23:02:44', '2025-06-10 23:02:44', 1, NULL, NULL, 3),
(3, 3, 3, '2025-06-07', 'Apendisitis pasca operasi', 'Pasca operasi lancar, observasi rawat inap.', '2025-06-10 23:02:44', '2025-06-10 23:02:44', 4, NULL, NULL, 3),
(4, 4, 3, '2025-06-09', 'Vertigo vestibular', 'Pemberian betahistine efektif.', '2025-06-10 23:02:44', '2025-06-10 23:02:44', 1, NULL, NULL, 3),
(5, 5, 3, '2025-06-11', 'Dermatitis sembuh', 'Pasien menunjukkan perbaikan setelah pengobatan.', '2025-06-10 23:02:44', '2025-06-10 23:02:44', 1, NULL, NULL, 3),
(6, 6, 3, '2025-06-14', 'tekanan darah tinggi', 'perbaiki posisi duduk, kurangi begadang', '2025-06-13 22:19:17', '2025-06-13 22:20:11', 1, NULL, NULL, 3);
...
INSERT INTO `diagnosa_awal` (`id`, `pasien_id`, `user_id`, `tanggal`, `diagnosa`, `catatan`, `status`, `created_at`, `updated_at`, `master_diagnosa_id`, `jenis_diagnosa`, `kasus`, `pelayanan_id`) VALUES
(1, 1, 4, '2025-06-01', 'Migrain akut', 'Disarankan terapi obat dan istirahat cukup.', 'belum_diperiksa', '2025-06-10 23:00:32', '2025-06-10 23:00:32', 5, NULL, NULL, 3),
(2, 2, 4, '2025-06-03', 'Asma bronkial ringan', 'Pasien diberikan inhaler dan edukasi lingkungan.', 'belum_diperiksa', '2025-06-10 23:00:32', '2025-06-10 23:00:32', 1, NULL, NULL, 3),
(3, 3, 4, '2025-06-06', 'Apendisitis akut', 'Pasien dijadwalkan untuk operasi.', 'belum_diperiksa', '2025-06-10 23:00:32', '2025-06-10 23:00:32', 4, NULL, NULL, 3),
(4, 4, 4, '2025-06-08', 'Vertigo sentral', 'Direkomendasikan MRI jika gejala berlanjut.', 'belum_diperiksa', '2025-06-10 23:00:32', '2025-06-10 23:00:32', 1, NULL, NULL, 3),
(5, 5, 4, '2025-06-10', 'Dermatitis kontak', 'Berikan antihistamin topikal dan edukasi kebersihan.', 'belum_diperiksa', '2025-06-10 23:00:32', '2025-06-10 23:00:32', 1, NULL, NULL, 3),
(6, 6, 4, '2025-06-14', 'skoliosis dan tekanan darah tinggi', 'kurangi begadang dan duduk di kursi terlalu lama', 'sudah_diperiksa', '2025-06-13 22:10:47', '2025-07-02 15:51:28', 1, NULL, NULL, 3);
...
(7, 'Dopamine', 3, 20, 'dosis tinggi', '2025-06-13 23:19:17', '2025-06-13 23:22:20');
...
CREATE TABLE `pelayanan_tindakan` (
  `id` bigint UNSIGNED NOT NULL,
  `pelayanan_id` bigint UNSIGNED NOT NULL,
...
(6, 6, 5, '2025-06-14', 'Tidak Lengkap', '2025-06-13 22:39:51', '2025-06-13 22:40:10');
...
(9, 2, 8, '2025-07-08', 'pusing, mual, pegal-pegal', '100', '30', 'demam', 1, NULL, 'sudah', '2025-07-07 16:15:43', '2025-07-07 16:17:32');

-- --------------------------------------------------------

--
-- Struktur dari tabel `perawat_dokter`
--

CREATE TABLE `perawat_dokter` (
  `id` bigint UNSIGNED NOT NULL,
  `perawat_id` bigint UNSIGNED NOT NULL,
  `dokter_id` bigint UNSIGNED NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(6, 6, 3, 1, '2025-06-14', 'Amoxillin 100mg,diminum 2x sehari', '2025-06-13 22:27:40', '2025-06-25 20:58:48');
...
(7, 7, '2026-06-17', '2025-06-17', NULL, 'dosis tinggi', '2025-06-17 06:48:14', '2025-06-17 06:48:14');
...
--
-- Indeks untuk tabel `pelayanan_tindakan`
--
ALTER TABLE `pelayanan_tindakan`
  ADD PRIMARY KEY (`id`),
  ADD KEY `pelayanan_tindakan_pelayanan_id_foreign` (`pelayanan_id`),
  ADD KEY `pelayanan_tindakan_tindakan_id_foreign` (`tindakan_id`);
...
--
-- Indeks untuk tabel `perawat_dokter`
--
ALTER TABLE `perawat_dokter`
  ADD PRIMARY KEY (`id`),
  ADD KEY `perawat_dokter_perawat_id_foreign` (`perawat_id`),
  ADD KEY `perawat_dokter_dokter_id_foreign` (`dokter_id`);
...
--
-- AUTO_INCREMENT untuk tabel `pelayanan_tindakan`
--
ALTER TABLE `pelayanan_tindakan`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT untuk tabel `perawat_dokter`
--
ALTER TABLE `perawat_dokter`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `pelayanan_tindakan`
  ADD CONSTRAINT `pelayanan_tindakan_pelayanan_id_foreign` FOREIGN KEY (`pelayanan_id`) REFERENCES `pelayanan` (`id`),
  ADD CONSTRAINT `pelayanan_tindakan_tindakan_id_foreign` FOREIGN KEY (`tindakan_id`) REFERENCES `tindakan` (`id`);
...
--
-- Ketidakleluasaan untuk tabel `perawat_dokter`
--
ALTER TABLE `perawat_dokter`
  ADD CONSTRAINT `perawat_dokter_dokter_id_foreign` FOREIGN KEY (`dokter_id`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `perawat_dokter_perawat_id_foreign` FOREIGN KEY (`perawat_id`) REFERENCES `users` (`id`);
