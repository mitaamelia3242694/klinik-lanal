...
class KetersediaanObatController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $sediaan->stok_total = $sediaan->stok_total + $request->stok_total;

        // Update data lainnya
        $sediaan->obat_id = $request->obat_id;
        $sediaan->tanggal_masuk = $request->tanggal_masuk;
        $sediaan->tanggal_kadaluarsa = $request->tanggal_kadaluarsa;
        $sediaan->keterangan = $request->keterangan;
