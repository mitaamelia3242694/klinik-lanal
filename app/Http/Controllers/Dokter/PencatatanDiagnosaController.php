...
class PencatatanDiagnosaController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('Dokter.pencatatan-diagnosa.index', compact('diagnosas', 'pasiens', 'dokters'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('Dokter.pencatatan-diagnosa.edit', compact('diagnosa', 'pasiens', 'dokters'));
    }
