...
<section class="blank-content">
    ...
    <form method="GET" action="{{ route('data-pasien.index') }}"
        ...
        <select name="filter_asuransi" class="input-style" style="max-width: 180px;">
            ...
            <option value="punya" {{ request('filter_asuransi') === 'punya' ? 'selected' : '' }}>Punya Asuransi</option>
            <option value="tidak" {{ request('filter_asuransi') === 'tidak' ? 'selected' : '' }}>Tidak Punya Asuransi
            </option>
        </select>
